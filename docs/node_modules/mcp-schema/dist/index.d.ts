 ...
 */
export type { McpSpec, McpTool, ToolAnnotations, McpResource, McpResourceTemplate, ResourceAnnotations, McpPrompt, McpPromptArgument, McpServerInfo, McpCapabilities, McpTransport, JsonSchema, } from "./types.js";
export { mcpSpecSchema } from "./schema.js";
/** Current mcp-spec format version. */
export declare const MCP_SPEC_VERSION = "0.2.0";
