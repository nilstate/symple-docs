 ...
 */
export function generateExample(schema, seen = new Set()) {
...
function generateObjectExample(schema, seen) {
    const obj = {};
    if (schema.properties) {
...
function generateArrayExample(schema, seen) {
    if (schema.items) {
...
function mergeAllOfExamples(schemas, seen) {
    const merged = {};
